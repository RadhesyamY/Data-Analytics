...
# ----------------------------------------------
# Step 1 - Read the data--S:\Shyam\POST MIZE\STAT\KNO\AzML\AI ML\Resources\Simple Regression\BikeSharing
# ----------------------------------------------
bikes = pd.read_csv('S:\Shyam\POST MIZE\STAT\KNO\AzML\AI ML\Resources\Simple Regression\BikeSharing.csv')
